...
from routers import menu, gallery, bookings, admin, combos, banquets

app = FastAPI(
    title="Cay Tung Restaurant API",
    description="API for Cay Tung restaurant website — menu, gallery, and bookings",
    version="1.0.0",
    lifespan=lifespan
)
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:5173",
        "http://localhost:3000",
        "https://caytungrestaurant.vercel.app",
        "https://caytung-api.japanwest.cloudapp.azure.com",
    ],
