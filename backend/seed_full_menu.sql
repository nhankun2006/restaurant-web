...
-- ============================================
-- 4. Insert Combo Menus & Combo Menu Items
-- ============================================
...
-- Link menu_item_id in combo_menu_items if matching item exists in menu_items
UPDATE combo_menu_items cmi
SET menu_item_id = mi.id
FROM menu_items mi
WHERE LOWER(TRIM(cmi.item_name)) = LOWER(TRIM(mi.name));

-- ============================================
-- 5. Insert Banquet Services
-- ============================================
